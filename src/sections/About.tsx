...
const About = () => {
  return (
    <section
  id="about" className="relative py-32 ">
      ...
      <Container>
        ...
        <div className="mb-20">
          ...
          <h2 className="max-w-[700px] text-5xl md:text-6xl font-semibold leading-tight tracking-[-0.04em]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {/* BIG INTRO CARD */}
          <div className="lg:col-span-2 lg:row-span-2 rounded-[32px] border border-white/10 bg-white/[0.03] backdrop-blur-xl p-8 flex flex-col justify-between min-h-[520px]">
          ...
          {/* CARD 1 */}
          <div className="rounded-[32px] border border-white/10 bg-gradient-to-br from-purple-500/10 to-transparent p-7 min-h-[250px]">
          ...
          {/* CARD 2 */}
          <div className="rounded-[32px] border border-white/10 bg-gradient-to-br from-cyan-500/10 to-transparent p-7 min-h-[250px]">
          ...
          {/* CARD 3 */}
          <div className="lg:col-span-2 rounded-[32px] border border-white/10 bg-white/[0.03] backdrop-blur-xl p-8 min-h-[250px] flex flex-col justify-between">
          ...
          {/* CARD 4 */}
          <div className="rounded-[32px] border border-white/10 bg-white/[0.03] backdrop-blur-xl p-7 min-h-[250px]">
          ...
          {/* CARD 5 */}
          <div className="rounded-[32px] border border-white/10 bg-gradient-to-br from-white/[0.05] to-transparent p-7 min-h-[250px]">
